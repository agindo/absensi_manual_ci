		...
		<div class="row">
			<div class="col-sm-12">
				...
				<ul id="myTabs" class="nav nav-tabs" role="tablist">
					<li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true"><i class="fa fa-clipboard"></i> Data Posisi</a></li>
				...
				<div id="myTabContent" class="tab-content">
						...
						<table class="table table-condensed table-bordered table-hovered" id="example1">
							...
							<tbody>
								...
								<tr>
									...
									<td><small><?php echo anchor('posisi/update/'.$value->id, '<i class="fa fa-pencil"></i>', array("class"=>"btn btn-info btn-xs btn-block"));?></small></td>
									<td><small><?php echo anchor('posisi/delete/'.$value->id, '<i class="fa fa-remove"></i>', array("class"=>"btn btn-danger btn-xs btn-block"));?></small></td>
								</tr>
								<?php
										$no++;
									}
					...
					<div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledBy="profile-tab">
						...
						<?php echo form_open('posisi/add');?>
							<div class="row">
								<div class="col-sm-2">&nbsp;</div>
								<div class="col-sm-6" style="padding-right:2px">
									<div class="form-group" style="margin-top:10px">
										<label><small>Nama Posisi</small></label>
										<input type="text" name="text_posisi" id="" class="form-control input-sm" placeholder="Nama Posisi" required data-bv-notempty-message="Nama Posisi Tidak Boleh Kosong">
									</div>
								</div>
								<div class="col-sm-1" style="padding-right:1px;padding-top:35px">
									<button type="submit" name="posisi_submit" id="" class="btn btn-primary btn-sm btn-block">Simpan</button>
								</div>	
